    ...
    <>
      ...
      <div className="page-padding">
        <div className="container padding-top">
          ...
          <p className="press-kit-copy">
            we've built up momentum, with four singles released, <b><ExternalLink href={EXTERNAL_LINKS.tracks.xxii.spotify} target="_blank">XXII</ExternalLink></b>, <b><ExternalLink href={EXTERNAL_LINKS.tracks.krakensbane.spotify} target="_blank">KRAKENSBANE</ExternalLink></b>, and <b><ExternalLink href={EXTERNAL_LINKS.tracks.cologne.spotify} target="_blank">COLOGNE</ExternalLink></b> each hitting over one thousand streams in their first week of release, and our latest single <b><ExternalLink href={EXTERNAL_LINKS.tracks.tower.spotify} target="_blank">TOWER</ExternalLink></b> out at the end of june 2026.
