    ...
    <>
      ...
      <div className="page-padding">
        <div className="container padding-top">
          ...
          <p className="press-kit-copy">
            we've built up momentum, with four singles released so far. <b><ExternalLink href={EXTERNAL_LINKS.tracks.xxii.spotify} target="_blank">XXII</ExternalLink></b>, <b><ExternalLink href={EXTERNAL_LINKS.tracks.krakensbane.spotify} target="_blank">KRAKENSBANE</ExternalLink></b>, and <b><ExternalLink href={EXTERNAL_LINKS.tracks.cologne.spotify} target="_blank">COLOGNE</ExternalLink></b> each hitting over one thousand streams in their first week of release, and our latest single <b><ExternalLink href={EXTERNAL_LINKS.tracks.tower.spotify} target="_blank">TOWER</ExternalLink></b>, a dark and explosive love song that channels Hozier's poetic lyricism with Cleopatrick's snarling guitar work, out at the end of june 2026.
          ...
          <p className="press-kit-copy">
            wendigo started as a solo project by singer/guitarist and songwriter <b>theo stewart griffiths</b>, who has played across the uk in many bands on many instruments, from underground club shows, to regional tours. it has now evolved into a full band 
